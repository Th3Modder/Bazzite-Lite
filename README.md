...
Built on [bootc](https://github.com/bootc-dev/bootc) technology for efficient container-based OS management, Bazzite-Lite includes streamlined tools for creating disk images (ISO, QCOW2, RAW) and a[...]
